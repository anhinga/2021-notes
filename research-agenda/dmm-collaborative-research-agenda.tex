...
\vspace{0.085in}
February 13, 2021\footnote{Version 2.2. Version 2.0 (08-07-20) is at
...
For a more detailed analysis of choosing a PyTorch-like platform for DMM implementation vs choosing one of next generation ultra-flexible
...
formalism would provide differential programming (``Software 2.0") capabilities\footnote{In this section we use 
``differential programming" and ``Software 2.0" interchangeably while recognizing that modern differential
...
stream-oriented programming, and {\em the implementing team needs to provides capabilities of combining several streams with
...
At the same time, the whole point of modern differential programming (mostly, in its Julia Flux and Python/JAX
incarnations) is that one can incorporate fragments of models straight into a reasonably general subset of
Julia or Python. In particular, one can incorporate fragments of DMMs and DMM-related constructions straight into
Julia or Python; therefore one can start using various DMM-related methods without being purist and without
...
of the quest to understand why this architecture and especially its GPT-3 incarnation work so well\footnote{As of early August 2020 when I was writing this; the ``DMMs and Transformers" section of this document needs to be updated to reflect changes  since August 2020, including our own work.}.

It's quite promising at this point to consider interplay between attention-based models including Transformers and
other approaches. Hybrid approaches of this kind can bring progress along multiple axes.
