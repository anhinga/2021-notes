...
\vspace{0.085in}
February 17, 2021\footnote{Version 2.2.1. Version 2.0 (08-07-20) is at
...
JAX has a comparable degree of flexibility as well with its {\bf pytree} protocol and differential programming capabilities,
...
Julia or Python, and using the resulting programs as more expressive models with strong priors. In particular, one can incorporate fragments of DMMs and DMM-related constructions straight into
Julia or Python; therefore one can start using various DMM-related methods within a differential programming
